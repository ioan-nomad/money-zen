<script lang="ts">
  ...
  $: selectedCategory = $categoryStore.find(c => c.id === selectedId);

  // Group categories by type
  $: incomeCategories = $categoryStore.filter(c => c.category_type === 'income');
  $: expenseCategories = $categoryStore.filter(c => c.category_type === 'expense');
